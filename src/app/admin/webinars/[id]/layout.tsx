    ...
    <div>
      <div className="bg-white border-b border-slate-200 -mx-6 -mt-6 px-6 py-4 mb-0">
        <div className="flex items-center gap-4">
          <Link href="/admin/webinars" className="p-2 hover:bg-slate-100 rounded-lg transition-colors">
          ...
          <Link href={`/w/${webinar.slug}`} target="_blank" className="text-sm text-indigo-600 hover:text-indigo-800">
            Ver pagina →
          </Link>
        </div>
      </div>
